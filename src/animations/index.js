...
export const LOTTIE_ANIMATIONS = {
  mobileChatDialog: '/Assets/Animations/Mobile chat dialog application interface.lottie',
  robotFuturistic: '/Assets/Animations/Robot Futuristic Ai animated.lottie',
};

// JSON animations (imported directly)
export {
  VoiceCallHeader,
  AiLoadingModel,
  Revenue,
